...
from modules.knockerconfig import KnockerConfig
...
def main():
    ...
    if options.config_filename:
        ...
        tester = Tester(parser.get_parsed_requests(), knocker_conf, req, {"user_1": options.user_1_token, "user_2": options.user_2_token})
